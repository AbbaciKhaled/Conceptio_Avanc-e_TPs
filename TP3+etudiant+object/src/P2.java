	...
	public static void main(String[] args) {
		...
		try {
			...
			while(true) {
				...
				case 1:
				{
					int x = rmiServer.update("insert into student values ('"+a.get(1)+"','"+a.get(2)+"','"+a.get(3)+"');");
					int x2 = rmiServer2.update("insert into student (matricule, nom, prenom) values ('"+a.get(1)+"','"+a.get(2)+"','"+a.get(3)+"');");
				...
				case 2:
				{
					int x = rmiServer.update("delete from student where matricule = "+a.get(1));
					int x2 = rmiServer2.update("delete from student where matricule = "+a.get(1));
				...
				case 3:
				{
					Student x = rmiServer.select("select nom, prenom from student where matricule = "+a.get(1));
					out.writeObject(x);
					
					Student x2 = rmiServer2.select("select nom, prenom from student where matricule = "+a.get(1));
					out.writeObject(x2);
					break;
				}
				...
				case 4:
				{
					ArrayList <Student> x = rmiServer.list("select nom, prenom from student");
					out.writeObject(x);
					
					ArrayList <Student> x2 = rmiServer2.list("select nom, prenom from student");
					out.writeObject(x2);
					break;
				}
